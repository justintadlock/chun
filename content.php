<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
	...
	<?php if ( is_singular( get_post_type() ) ) { ?>
		...
		<header class="entry-header">
			...
			<?php echo apply_atomic_shortcode( 'byline', '<div class="byline">' . __( 'Published by [entry-author] on [entry-published] [entry-comments-link before=" | "] [entry-edit-link before=" | "]', 'chun' ) . '</div>' ); ?>
		</header><!-- .entry-header -->
